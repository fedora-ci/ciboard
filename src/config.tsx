...
export const messages = {
  kaiConnectionError: (
    <div>
      <div>
        <strong>
          Note that during weekends the backend can be down for maintanance.
          Please retry later.
        </strong>
      </div>
      <br />
      <div>
        Make sure you have Red Hat internal CA imported into your browser, you
        are connected to the internal network and and you are not using the
        corporate proxy.
      </div>
      <div>
